...
from remote_execution import RemoteExecution, RemoteExecutionConfig, MODE_EXEC_FILE, MODE_EXEC_STATEMENT

SCRIPT = r"E:\游戏\符济\Rune-of-Succor\符济\Content\Python\stitch_crouch_loops.py"
